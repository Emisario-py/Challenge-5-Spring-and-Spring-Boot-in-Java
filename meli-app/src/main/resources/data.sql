...
-- ========================================
-- Insertar Items (Productos en las órdenes)
-- ========================================

-- Items para Orden 1 (Cliente: Juan Pérez)
...
-- Items para Orden 2 (Cliente: María González)
...
-- Items para Orden 5 (Cliente: Ana López)
...
-- Items para Orden 6 (Cliente: María González)
...
-- Items para Orden 7 (Cliente: Pedro Martínez)
